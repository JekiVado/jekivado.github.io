...
assert.match(app, /const ringCount = 46;/);
assert.match(app, /const ringGap = 12;/);
assert.match(app, /const ringTrack = 'THE CONTENT ARCHITECTURE · ';/);
assert.match(app, /isText: ring % 3 === 0 \|\| ring > 37,/);
...
assert.match(app, /const visibleRadius = size \* 1\.14;/);
assert.match(app, /const centerX = width \* \(\.48 \+ \(pointer\.x - \.5\) \* \.012\);/);
