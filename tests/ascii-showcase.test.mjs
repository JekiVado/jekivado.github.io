...
assert.match(app, /function drawGlyphBands/);
assert.match(app, /const centerX = width \* \.48;/);
assert.match(app, /const designScale = size \/ 540;/);
assert.match(app, /const dotSize = 5 \* designScale;/);
