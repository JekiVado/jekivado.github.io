...
assert.match(root, /404/);
assert.match(root, /PAGE NOT FOUND/);
assert.match(root, /The requested resource could not be located\./);
assert.match(root, /<main class="error-page">/);
assert.match(root, /color-scheme:\s*light/);
assert.match(root, /background:\s*#f7f5ef/);
assert.doesNotMatch(root, /background:\s*#101317/);
